...
num_participant = int(environ.get("NUM_PARTICIPANT", 7))  # this is the 7-participant ver.
...
SESSION_CONFIGS = [
    dict(
        ...
        app_sequence = ['phase1', 'phase2', 'phase_AI', 'phase3', 'phase_AI_2','after_questionaire'],
    ),
]
